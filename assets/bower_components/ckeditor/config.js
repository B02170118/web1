...
CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'Save,NewPage,PasteFromWord,Form,Checkbox,Radio,TextField,Textarea,Select,Button,HiddenField,CopyFormatting,CreateDiv,Language,Anchor,Flash,Table,PageBreak,Iframe,Smiley,Maximize,About';
};