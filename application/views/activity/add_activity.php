...
<main class="content">
    <?php echo form_open_multipart("activity/form_add_activity"); ?>
        ...
        <div class="box-body">
            <table id="data-table" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <div class='input-group date datetimepicker'>
                            <input type='text' class="form-control" name="start_time" readonly required>
                ...
                <tr>
                    ...
                    <td>
                        <div class='input-group date datetimepicker'>
                            <input type='text' class="form-control" name="end_time" readonly required>
                            <span class="input-group-addon">
                                <span class="glyphicon glyphicon-calendar">
                                </span>
                            </span>
