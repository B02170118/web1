...
<main id="makeup" class="content">
    ...
    <section id="makeup_info" class="box box-default">
        ...
        if (!empty($category)) {
        ?>
            <?php echo form_open_multipart("makeup/form_edit_category"); ?>
            ...
            <div class="box-body">
                <table id="data-table" class="table table-striped">
                    ...
                    <tr>
                        <th>建議比例</th>
                        <td class="text-info">W640xH860 72dpi</td>
                    </tr>
                    <tr>
                        <th>封面圖</th>
                        <td>
    ...
    <section id="makeup_view" class="box box-default">
        <div class="box-header with-border">
        ...
        <div class="box-btns">
            ...
            if (!empty($category)) {
            ?>
                <a id="upload_btn" href="./makeup/upload_img/<?php echo $category['id'] ?>" class="btn btn-primary">
