...
<main id="makeup" class="content">
    ...
    <section id="makeup_album" class="box box-default">
        ...
        <div class="box-btns">
            <a id="add_btn" href="./makeup/add_category" class="btn btn-primary">
            ...
            <ul id="sortable">
                ...
                ?>
                        <li data-cid="<?php echo $row['id'] ?>">
                            ...
                            <a href="makeup/makeup_category_view/<?php echo $row['id'] ?>">
