...
<main id="dress" class="content">
    ...
    <section id="dress_info" class="box box-default">
        <div class="box-header with-border">
            <h2 class="box-title">編輯相簿</h2>
        </div>
        <?php
        if (!empty($category)) {
        ?>
            <?php echo form_open_multipart("dress/form_edit_category"); ?>
            ...
            <div class="box-body">
                <table id="data-table" class="table table-striped">
                    <tr>
                        <th>相簿ID</th>
                        <td>
                            <input type="text" class="form-control" value="<?php echo $category['id'] ?>" disabled="disabled">
    ...
    <section id="dress_view" class="box box-default">
        <div class="box-header with-border">
        ...
        <div class="box-btns">
            ...
            if (!empty($category)) {
            ?>
                <a id="upload_btn" href="./dress/upload_img/<?php echo $category['id'] ?>" class="btn btn-primary">
                    <i class="fa fa-image"></i>上傳相片
                </a>
                <button id="sort_btn" onclick="sort()" class="btn btn-info">
                    <i class="fa fa-sort"></i>相片排序
                </button>
                ...
                <button id="submit_del" class="btn btn-danger" style="display:none" onclick="submit_del(this)">
            ...
            <ul id="sortable">
                ...
                ?>
                        <li data-id="<?php echo $row['id'] ?>">
                            ...
                            <img src="<?php echo WWW_test1111_COM . $row['img'] ?>" alt="">
